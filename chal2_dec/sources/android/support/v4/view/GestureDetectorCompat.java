        ...
        public boolean onTouchEvent(MotionEvent motionEvent) {
            ...
            switch (action) {
                ...
                case 1:
                    ...
                    if (this.mIsDoubleTapping) {
                        ...
                        if (this.mInLongPress) {
                            ...
                            f3 = VelocityTrackerCompat.getYVelocity(velocityTracker, pointerId);
                ...
                case 6:
                    ...
                    f3 = VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, pointerId2);
                    for (actionIndex = 0; actionIndex < pointerCount; actionIndex++) {
                        if (actionIndex != action) {
                            i = motionEvent.getPointerId(actionIndex);
                            if ((VelocityTrackerCompat.getXVelocity(this.mVelocityTracker, i) * xVelocity2) + (VelocityTrackerCompat.getYVelocity(this.mVelocityTracker, i) * f3) < 0.0f) {
