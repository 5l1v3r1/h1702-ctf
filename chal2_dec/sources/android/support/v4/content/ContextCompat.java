...
public class ContextCompat {
    ...
    public static File[] getObbDirs(Context context) {
        ...
        if (i >= 11) {
            ...
            context = buildPath(Environment.getExternalStorageDirectory(), DIR_ANDROID, DIR_OBB, context.getPackageName());
        }
    ...
    public static boolean isDeviceProtectedStorage(Context context) {
        return BuildCompat.isAtLeastN() ? ContextCompatApi24.isDeviceProtectedStorage(context) : null;
    }
}
