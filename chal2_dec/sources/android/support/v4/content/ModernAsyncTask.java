...
*/
            /*
            r2 = this;
            r0 = r2.get();	 Catch:{ InterruptedException -> 0x0027, ExecutionException -> 0x001a, CancellationException -> 0x0013, Throwable -> 0x000a }
        ...
        L_0x000a:
            ...
            r1 = "An error occurred while executing doInBackground()";
            r0.<init>(r1, r2);
            throw r0;
        L_0x0013:
            r2 = android.support.v4.content.ModernAsyncTask.this;
            r0 = 0;
            r2.postResultIfNotInvoked(r0);
            goto L_0x002d;
        L_0x001a:
            r2 = move-exception;
            r0 = new java.lang.RuntimeException;
