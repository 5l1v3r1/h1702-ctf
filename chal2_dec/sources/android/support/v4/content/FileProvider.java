...
*/
        ...
        L_0x0054:
            ...
            r5 = "Resolved path jumped beyond configured root";
            r4.<init>(r5);
            throw r4;
        L_0x005c:
            return r0;
    ...
    public Cursor query(Uri uri, String[] strArr, String str, String[] strArr2, String str2) {
        ...
        uri = copyOf(objArr, i);
        strArr = new MatrixCursor(copyOf, 1);
        strArr.addRow(uri);
        return strArr;
    }
    ...
    public String getType(Uri uri) {
        File fileForUri = this.mStrategy.getFileForUri(uri);
        uri = fileForUri.getName().lastIndexOf(46);
        if (uri >= null) {
            String mimeTypeFromExtension = MimeTypeMap.getSingleton().getMimeTypeFromExtension(fileForUri.getName().substring(uri + 1));
