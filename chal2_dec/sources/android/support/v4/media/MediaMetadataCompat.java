...
public final class MediaMetadataCompat implements Parcelable {
    ...
    public static final class Builder {
                ...
                if (obj != null && (obj instanceof Bitmap)) {
                    ...
                    if (bitmap.getHeight() <= i) {
                        if (bitmap.getWidth() <= i) {
                            if (VERSION.SDK_INT >= 14 && (str.equals(MediaMetadataCompat.METADATA_KEY_ART) || str.equals(MediaMetadataCompat.METADATA_KEY_ALBUM_ART))) {
        ...
        public Builder putString(String str, String str2) {
            ...
            str2.append("The ");
            str2.append(str);
            str2.append(" key cannot be used to put a String");
        ...
        public Builder putLong(String str, long j) {
            ...
            j.append("The ");
            j.append(str);
            j.append(" key cannot be used to put a long");
