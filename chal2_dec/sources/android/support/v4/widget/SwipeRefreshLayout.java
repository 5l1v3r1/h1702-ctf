...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attributeSet) {
        ...
        this.mAnimateToCorrectPosition = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                ...
                SwipeRefreshLayout.this.setTargetOffsetTopAndBottom((SwipeRefreshLayout.this.mFrom + ((int) (((float) (transformation - SwipeRefreshLayout.this.mFrom)) * f))) - SwipeRefreshLayout.this.mCircleView.getTop(), false);
                SwipeRefreshLayout.this.mProgress.setArrowScale(1065353216 - f);
            }
        };
    ...
    public void setRefreshing(boolean z) {
        ...
        setTargetOffsetTopAndBottom(z - this.mCurrentTargetOffsetTop, true);
        this.mNotify = false;
    ...
    void startScaleDownAnimation(AnimationListener animationListener) {
        this.mScaleDownAnimation = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                SwipeRefreshLayout.this.setAnimationProgress(1065353216 - f);
            }
        };
    ...
    public boolean onStartNestedScroll(View view, View view2, int i) {
        return (isEnabled() == null || this.mReturningToStart != null || this.mRefreshing || (i & 2) == 0) ? false : true;
    }
    ...
    public void onNestedPreScroll(View view, int i, int i2, int[] iArr) {
        ...
        if (dispatchNestedPreScroll(i - iArr[0], i2 - iArr[1], view, null)) {
    ...
    private void startDragging(float f) {
        if (f - this.mInitialDownY > ((float) this.mTouchSlop) && this.mIsBeingDragged == null) {
            ...
            this.mProgress.setAlpha(1.06E-43f);
        }
    }
    ...
    void moveToStart(float f) {
        setTargetOffsetTopAndBottom((this.mFrom + ((int) (((float) (this.mOriginalOffsetTop - this.mFrom)) * f))) - this.mCircleView.getTop(), 0.0f);
    }

    @SuppressLint({"NewApi"})
    private void startScaleDownReturnToStartAnimation(int i, AnimationListener animationListener) {
        this.mFrom = i;
        if (isAlphaUsedForScale() != 0) {
