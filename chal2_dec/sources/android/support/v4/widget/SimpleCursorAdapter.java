            ...
            if (findViewById != null) {
                if (context != null ? context.setViewValue(findViewById, cursor, iArr[i]) : false) {
                    ...
                    if (findViewById instanceof TextView) {
                        ...
                        view.append(findViewById.getClass().getName());
                        view.append(" is not a ");
                        view.append(" view that can be bounds by this SimpleCursorAdapter");
...
*/
        /*
        r0 = this;
        r0 = java.lang.Integer.parseInt(r2);	 Catch:{ NumberFormatException -> 0x0008 }
        r1.setImageResource(r0);	 Catch:{ NumberFormatException -> 0x0008 }
        goto L_0x000f;
    L_0x0008:
