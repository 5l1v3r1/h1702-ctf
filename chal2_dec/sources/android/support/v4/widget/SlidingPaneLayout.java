...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public SlidingPaneLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        this.mOverhangSize = (int) ((32.0f * i) + 0.5f);
        ViewConfiguration.get(context);
        setWillNotDraw(null);
        ViewCompat.setAccessibilityDelegate(this, new AccessibilityDelegate());
        ViewCompat.setImportantForAccessibility(this, 1);
        this.mDragHelper = ViewDragHelper.create(this, 0.5f, new DragHelperCallback());
        this.mDragHelper.setMinVelocity(1137180672 * i);
    }
        ...
        while (true) {
            ...
            if (childAt.getVisibility() == 8) {
                ...
                if (layoutParams.width == -2) {
                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(paddingLeft - i5, Integer.MIN_VALUE);
                } else if (layoutParams.width == -1) {
                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(paddingLeft - i5, 1073741824);
                } else {
                    makeMeasureSpec = MeasureSpec.makeMeasureSpec(layoutParams.width, 1073741824);
                }
                if (layoutParams.height == -2) {
                    makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                } else if (layoutParams.height == -1) {
                    makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(paddingTop, 1073741824);
                } else {
                    makeMeasureSpec2 = MeasureSpec.makeMeasureSpec(layoutParams.height, 1073741824);
                }
                childAt.measure(makeMeasureSpec, makeMeasureSpec2);
                makeMeasureSpec = childAt.getMeasuredWidth();
                i5 = childAt.getMeasuredHeight();
                if (mode2 == Integer.MIN_VALUE && i5 > i3) {
                    i3 = Math.min(i5, paddingTop);
                }
                i4 -= makeMeasureSpec;
                z = i4 < 0;
                ...
                if (childAt2.getVisibility() != i5) {
                    ...
                    if (childAt2.getVisibility() != i5) {
                        ...
                        if (obj != null) {
                            ...
                            makeMeasureSpec2 = childAt2.getMeasuredWidth();
                        }
                        if (!z2 || childAt2 == slidingPaneLayout.mSlideableView) {
                            if (layoutParams2.weight > 0.0f) {
                                int makeMeasureSpec3;
                                if (layoutParams2.width != 0) {
                                    makeMeasureSpec3 = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                                } else if (layoutParams2.height == -2) {
                                    i5 = MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                                    if (z2) {
                                        i6 = mode;
                                        childAt2.measure(MeasureSpec.makeMeasureSpec(makeMeasureSpec2 + ((int) ((layoutParams2.weight * ((float) Math.max(0, i4))) / f)), 1073741824), i5);
                                        mode2++;
                                        mode = i6;
                                        i5 = 8;
                                    } else {
                                        makeMeasureSpec = paddingLeft - (layoutParams2.leftMargin + layoutParams2.rightMargin);
                                        i6 = mode;
                                        mode = MeasureSpec.makeMeasureSpec(makeMeasureSpec, 1073741824);
                                    ...
                                    makeMeasureSpec3 = MeasureSpec.makeMeasureSpec(paddingTop, 1073741824);
                                } else {
                                    makeMeasureSpec3 = MeasureSpec.makeMeasureSpec(layoutParams2.height, 1073741824);
                                }
                                i5 = makeMeasureSpec3;
                                if (z2) {
                                    i6 = mode;
                        ...
                        } else if (layoutParams2.width < 0 && (makeMeasureSpec2 > mode || layoutParams2.weight > 0.0f)) {
                            int i7;
                            if (obj == null) {
                                i7 = 1073741824;
                                makeMeasureSpec = MeasureSpec.makeMeasureSpec(childAt2.getMeasuredHeight(), 1073741824);
                            } else if (layoutParams2.height == -2) {
                                makeMeasureSpec = MeasureSpec.makeMeasureSpec(paddingTop, Integer.MIN_VALUE);
                                i7 = 1073741824;
                            } else if (layoutParams2.height == -1) {
                                i7 = 1073741824;
                            ...
                            childAt2.measure(MeasureSpec.makeMeasureSpec(mode, i7), makeMeasureSpec);
                        }
                    }
                }
                i6 = mode;
    ...
    private void dimChildView(View view, float f, int i) {
        ...
        if (f > 0.0f && i != 0) {
            ...
            if (ViewCompat.getLayerType(view) != 2.8E-45f) {
                ViewCompat.setLayerType(view, 2, layoutParams.dimPaint);
            }
            invalidateChildRegion(view);
        } else if (ViewCompat.getLayerType(view) != null) {
    ...
    boolean isDimmed(View view) {
        ...
        LayoutParams layoutParams = (LayoutParams) view.getLayoutParams();
        if (this.mCanSlide && layoutParams.dimWhenOffset != null && this.mSlideOffset > null) {
            z = true;
        }
        return z;
    }
