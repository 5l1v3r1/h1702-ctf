...
class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    private int evaluateColorChange(float f, int i, int i2) {
        ...
        return (intValue + ((int) (f * ((float) ((i2 & 255) - intValue))))) | ((((i + ((int) (((float) (((i2 >> 24) & 255) - i)) * f))) << 24) | ((i3 + ((int) (((float) (((i2 >> 16) & 255) - i3)) * f))) << 16)) | ((i4 + ((int) (((float) (((i2 >> 8) & 255) - i4)) * f))) << 8));
    }
    ...
    private void setupAnimators() {
        ...
        Animation anonymousClass1 = new Animation() {
            public void applyTransformation(float f, Transformation transformation) {
                if (MaterialProgressDrawable.this.mFinishing != null) {
                    MaterialProgressDrawable.this.applyFinishTranslation(f, ring);
                    return;
                }
                transformation = MaterialProgressDrawable.this.getMinProgressArc(ring);
                float startingEndTrim = ring.getStartingEndTrim();
                float startingStartTrim = ring.getStartingStartTrim();
                float startingRotation = ring.getStartingRotation();
                MaterialProgressDrawable.this.updateRingColor(f, ring);
                if (f <= 0.5f) {
                    ring.setStartTrim(startingStartTrim + ((MaterialProgressDrawable.MAX_PROGRESS_ARC - transformation) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation(f / 0.5f)));
                }
                if (f > 0.5f) {
                    ring.setEndTrim(startingEndTrim + ((MaterialProgressDrawable.MAX_PROGRESS_ARC - transformation) * MaterialProgressDrawable.MATERIAL_INTERPOLATOR.getInterpolation((f - 1056964608) / 1056964608)));
                }
                ring.setRotation(startingRotation + (1048576000 * f));
                MaterialProgressDrawable.this.setRotation((1129840640 * f) + (MaterialProgressDrawable.FULL_ROTATION * (MaterialProgressDrawable.this.mRotationCount / 5.0f)));
            }
        };
        ...
        anonymousClass1.setAnimationListener(new AnimationListener() {
            ...
            public void onAnimationStart(Animation animation) {
                MaterialProgressDrawable.this.mRotationCount = null;
            }
