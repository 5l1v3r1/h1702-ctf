...
final class BackStackRecord extends FragmentTransaction implements BackStackEntry, OpGenerator {
            ...
            if (!cls.isMemberClass() || Modifier.isStatic(modifiers)) {
                ...
                if (str != null) {
                    if (fragment.mTag == null || str.equals(fragment.mTag)) {
                        ...
                        i = new StringBuilder();
                        i.append("Can't change tag of fragment ");
                        i.append(fragment);
                        i.append(": was ");
                        i.append(fragment.mTag);
                        i.append(" now ");
                        i.append(str);
                ...
                if (i != 0) {
                    if (i == -1) {
                        i = new StringBuilder();
                        i.append("Can't add fragment ");
                        i.append(fragment);
                        i.append(" with tag ");
                        i.append(str);
                        i.append(" to container view with no id");
                        ...
                        str.append("Can't change container ID of fragment ");
                        str.append(fragment);
                        str.append(": was ");
                        str.append(fragment.mFragmentId);
                        str.append(" now ");
                        str.append(i);
    ...
    public FragmentTransaction addSharedElement(View view, String str) {
        if (SUPPORTS_TRANSITIONS) {
            ...
            if (this.mSharedElementSourceNames == null) {
                ...
                view.append("A shared element with the target name '");
                view.append(str);
                view.append("' has already been added to the transaction.");
                throw new IllegalArgumentException(view.toString());
            } else if (this.mSharedElementSourceNames.contains(view)) {
                str = new StringBuilder();
                str.append("A shared element with the source name '");
                str.append(view);
                str.append(" has already been added to the transaction.");
    ...
    private static boolean isFragmentPostponed(Op op) {
        op = op.fragment;
        return (!op.mAdded || op.mView == null || op.mDetached || op.mHidden || op.isPostponed() == null) ? null : true;
    }
