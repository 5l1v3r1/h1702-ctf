...
*/
    ...
    public void startIntentSenderForResult(IntentSender intentSender, int i, @Nullable Intent intent, int i2, int i3, int i4, Bundle bundle) throws SendIntentException {
        ...
        r1.mHost.onStartIntentSenderFromFragment(r1, intentSender, i, intent, i2, i3, i4, bundle);
    }
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        LayoutInflaterCompat.setFactory(bundle, this.mChildFragmentManager.getLayoutInflaterFactory());
        return bundle;
    }
