...
public class ListFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        layoutInflater = new FrameLayout(context);
        viewGroup = new LinearLayout(context);
        viewGroup.setId(INTERNAL_PROGRESS_CONTAINER_ID);
        viewGroup.setOrientation(1);
        viewGroup.setVisibility(8);
        viewGroup.setGravity(17);
        viewGroup.addView(new ProgressBar(context, null, 16842874), new LayoutParams(-2, -2));
        layoutInflater.addView(viewGroup, new LayoutParams(-1, -1));
        viewGroup = new FrameLayout(context);
        viewGroup.setId(INTERNAL_LIST_CONTAINER_ID);
        View textView = new TextView(context);
        textView.setId(INTERNAL_EMPTY_ID);
        textView.setGravity(17);
        viewGroup.addView(textView, new LayoutParams(-1, -1));
        bundle = new ListView(context);
        bundle.setId(16908298);
        bundle.setDrawSelectorOnTop(false);
        viewGroup.addView(bundle, new LayoutParams(-1, -1));
        layoutInflater.addView(viewGroup, new LayoutParams(-1, -1));
        layoutInflater.setLayoutParams(new LayoutParams(-1, -1));
