...
class RemoteInputCompatJellybean {
    ...
    static void addResultsToIntent(RemoteInput[] remoteInputArr, Intent intent, Bundle bundle) {
        ...
        remoteInputArr = new Intent();
        remoteInputArr.putExtra("android.remoteinput.resultsData", bundle2);
        intent.setClipData(ClipData.newIntent("android.remoteinput.results", remoteInputArr));
    }
}
