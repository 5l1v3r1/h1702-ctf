    ...
    private void checkOnClickListener(View view, AttributeSet attributeSet) {
        ...
        if (context instanceof ContextWrapper) {
            if (VERSION.SDK_INT < 15 || ViewCompat.hasOnClickListeners(view)) {
                ...
                attributeSet = obtainStyledAttributes.getString(null);
                if (attributeSet != null) {
                    view.setOnClickListener(new DeclaredOnClickListener(view, attributeSet));
                }
...
*/
    ...
    L_0x0036:
        ...
        r1 = r1.mConstructorArgs;	 Catch:{ Exception -> 0x0043 }
        r1 = r0.newInstance(r1);	 Catch:{ Exception -> 0x0043 }
        r1 = (android.view.View) r1;	 Catch:{ Exception -> 0x0043 }
        return r1;
    L_0x0043:
        r1 = 0;
        return r1;
