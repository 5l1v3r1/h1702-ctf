...
class ToolbarActionBar extends ActionBar {
    ...
    private final class PanelMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public void onCloseMenu(MenuBuilder menuBuilder, boolean z) {
            if (ToolbarActionBar.this.mWindowCallback) {
                ToolbarActionBar.this.mWindowCallback.onPanelClosed(false, menuBuilder);
            }
        }
...
*/
    ...
    L_0x001f:
        r5 = r5.mWindowCallback;	 Catch:{ all -> 0x0030 }
        r5 = r5.onPreparePanel(r4, r2, r0);	 Catch:{ all -> 0x0030 }
        if (r5 != 0) goto L_0x002a;	 Catch:{ all -> 0x0030 }
    L_0x0027:
        r0.clear();	 Catch:{ all -> 0x0030 }
    L_0x002a:
    ...
    View getListMenuView(Menu menu) {
        ...
        if (menu != null) {
            if (this.mListMenuPresenter != null) {
                if (this.mListMenuPresenter.getAdapter().getCount() > null) {
