...
class AppCompatDelegateImplV9 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    private class ListMenuDecorView extends ContentFrameLayout {
        ...
        public boolean onInterceptTouchEvent(MotionEvent motionEvent) {
            ...
            AppCompatDelegateImplV9.this.closePanel(null);
            return true;
        }
...
*/
    ...
    boolean onKeyShortcut(int i, KeyEvent keyEvent) {
        ...
        if (this.mPreparedPanel == 0 || performPanelShortcut(this.mPreparedPanel, keyEvent.getKeyCode(), keyEvent, 1) == 0) {
            if (this.mPreparedPanel == 0) {
                ...
                boolean performPanelShortcut = performPanelShortcut(i, keyEvent.getKeyCode(), keyEvent, 1);
                i.isPrepared = false;
                    ...
                    if (windowManager != null && preparePanel(panelFeatureState, keyEvent) != null) {
                            ...
                            if (panelFeatureState.refreshDecorView == null) {
                                if (panelFeatureState.createdPanelView != null) {
                                    ...
                                    if (layoutParams != null && layoutParams.width == -1) {
                                        ...
                                        layoutParams2 = new WindowManager.LayoutParams(i, -2, panelFeatureState.x, panelFeatureState.y, PointerIconCompat.TYPE_HAND, 8519680, -3);
                        ...
                        if (initializePanelContent(panelFeatureState)) {
                            if (panelFeatureState.hasPanelItems()) {
                                ...
                                keyEvent = panelFeatureState.shownPanelView.getParent();
                                if (keyEvent != null && (keyEvent instanceof ViewGroup)) {
                                    ((ViewGroup) keyEvent).removeView(panelFeatureState.shownPanelView);
                                }
    ...
    private void reopenMenu(MenuBuilder menuBuilder, boolean z) {
        if (this.mDecorContentParent == null || this.mDecorContentParent.canShowOverflowMenu() == null || (ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(this.mContext)) != null && this.mDecorContentParent.isOverflowMenuShowPending() == null)) {
    ...
    private boolean onKeyUpPanel(int i, KeyEvent keyEvent) {
        ...
        if (i != 0 || this.mDecorContentParent == 0 || this.mDecorContentParent.canShowOverflowMenu() == 0 || ViewConfigurationCompat.hasPermanentMenuKey(ViewConfiguration.get(this.mContext)) != 0) {
