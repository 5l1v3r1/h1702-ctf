...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    L_0x001e:
        r0 = r4.mContainerView;
        android.support.v4.view.ViewCompat.setTranslationY(r0, r1);
        r0 = r4.mContainerView;
        r0 = r0.getHeight();
        r0 = -r0;
        r0 = (float) r0;
    ...
    L_0x003d:
        ...
        android.support.v4.view.ViewCompat.setTranslationY(r5, r0);
    ...
    L_0x0061:
        r2 = r4.mContentView;
        android.support.v4.view.ViewCompat.setTranslationY(r2, r0);
        r0 = r4.mContentView;
    ...
    L_0x0088:
        ...
        android.support.v4.view.ViewCompat.setAlpha(r5, r0);
        r5 = r4.mContainerView;
        android.support.v4.view.ViewCompat.setTranslationY(r5, r1);
    ...
    L_0x0017:
        ...
        android.support.v4.view.ViewCompat.setAlpha(r0, r1);
        r0 = r4.mContainerView;
        r1 = 1;
    ...
    public void animateToMode(boolean z) {
        ...
        if (shouldAnimateContextView()) {
            ...
            if (z) {
                ViewPropertyAnimatorCompat viewPropertyAnimatorCompat2 = this.mDecorToolbar.setupAnimatorToVisibility(4, FADE_OUT_DURATION_MS);
                z = this.mContextView.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
                viewPropertyAnimatorCompat = viewPropertyAnimatorCompat2;
            } else {
                z = this.mDecorToolbar.setupAnimatorToVisibility(0, FADE_IN_DURATION_MS);
                viewPropertyAnimatorCompat = this.mContextView.setupAnimatorToVisibility(8, FADE_OUT_DURATION_MS);
            }
            ViewPropertyAnimatorCompatSet viewPropertyAnimatorCompatSet = new ViewPropertyAnimatorCompatSet();
            viewPropertyAnimatorCompatSet.playSequentially(viewPropertyAnimatorCompat, z);
