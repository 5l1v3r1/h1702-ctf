...
class AlertController {
            ...
            if (!this.mIsMultiChoice) {
                ...
                r1 = new CursorAdapter(this.mContext, this.mCursor, false) {
                    ...
                    public void bindView(View view, Context context, Cursor cursor) {
                        ...
                        view.setItemChecked(context, cursor);
                    }

                    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
                        return AlertParams.this.mInflater.inflate(alertController2.mMultiChoiceItemLayout, viewGroup, null);
                    }
                };
            }
    ...
    public boolean onKeyDown(int i, KeyEvent keyEvent) {
        return this.mScrollView != 0 && this.mScrollView.executeKeyEvent(keyEvent);
    }
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            ...
            if (this.mListView != null) {
                ((LinearLayout.LayoutParams) viewGroup.getLayoutParams()).weight = null;
                return;
            }
            return;
        }
    ...
    static void manageScrollIndicators(View view, View view2, View view3) {
        ...
        if (view3 != null) {
            if (ViewCompat.canScrollVertically(view, 1) != null) {
                i = 0;
            }
