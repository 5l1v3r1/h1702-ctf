...
public class LinearLayoutManager extends LayoutManager implements ViewDropHandler, ScrollVectorProvider {
    ...
    class AnchorInfo {
        ...
        boolean isViewValidAsAnchor(View view, State state) {
            ...
            return layoutParams.isItemRemoved() == null && layoutParams.getViewLayoutPosition() >= null && layoutParams.getViewLayoutPosition() < state.getItemCount();
        }
    ...
    protected int getExtraLayoutSpace(State state) {
        return state.hasTargetScrollPosition() != null ? this.mOrientationHelper.getTotalSpace() : 0;
    }
    ...
    public View onFocusSearchFailed(View view, int i, Recycler recycler, State state) {
        ...
        if (childClosestToStart.hasFocusable() == null) {
            return recycler;
        }
        if (recycler == null) {
            return null;
