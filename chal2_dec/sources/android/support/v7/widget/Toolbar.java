...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int i, int i2) {
        ...
        if (shouldLayout(r7.mNavButtonView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(0, ViewCompat.getMeasuredState(r7.mNavButtonView));
        } else {
            measuredWidth = 0;
            max = measuredWidth;
        ...
        if (shouldLayout(r7.mCollapseButtonView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(r7.mCollapseButtonView));
        }
        ...
        if (shouldLayout(r7.mMenuView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(r7.mMenuView));
        } else {
            measuredWidth = 0;
        }
        ...
        if (shouldLayout(r7.mExpandedActionView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(r7.mExpandedActionView));
        }
        if (shouldLayout(r7.mLogoView)) {
            ...
            combineMeasuredStates = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(r7.mLogoView));
        }
        i4 = getChildCount();
        max2 = max;
        max = i3;
        ...
        if (shouldLayout(r7.mTitleTextView)) {
            ...
            combineMeasuredStates2 = ViewUtils.combineMeasuredStates(combineMeasuredStates, ViewCompat.getMeasuredState(r7.mTitleTextView));
        ...
        if (shouldLayout(r7.mSubtitleTextView)) {
            ...
            combineMeasuredStates2 = ViewUtils.combineMeasuredStates(i3, ViewCompat.getMeasuredState(r7.mSubtitleTextView));
        } else {
            i3 = combineMeasuredStates2;
        }
    ...
    private int getViewListMeasuredWidth(List<View> list, int[] iArr) {
        ...
        while (iArr < size) {
            ...
            i4 = Math.max(0, -i4);
            i2 += (i3 + view.getMeasuredWidth()) + max;
            iArr++;
            i3 = Math.max(0, -i);
            i = i4;
        }
    ...
    private int layoutChildLeft(View view, int i, int[] iArr, int i2) {
        ...
        iArr = view.getMeasuredWidth();
        view.layout(i, childTop, i + iArr, view.getMeasuredHeight() + childTop);
        return i + (iArr + layoutParams.rightMargin);
    }
    ...
    private int layoutChildRight(View view, int i, int[] iArr, int i2) {
        ...
        int childTop = getChildTop(view, i2);
        iArr = view.getMeasuredWidth();
        view.layout(i - iArr, childTop, i, view.getMeasuredHeight() + childTop);
        return i - (iArr + layoutParams.leftMargin);
    }
