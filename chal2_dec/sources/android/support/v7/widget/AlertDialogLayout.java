...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        setMeasuredDimension(ViewCompat.resolveSizeAndState(i7 + (getPaddingLeft() + getPaddingRight()), i5, combineMeasuredStates), ViewCompat.resolveSizeAndState(paddingTop, i6, 0));
        if (mode != 1073741824) {
