...
public class GridLayoutManager extends LinearLayoutManager {
    ...
    private int getSpanGroupIndex(Recycler recycler, State state, int i) {
        ...
        String str = TAG;
        recycler = new StringBuilder();
        recycler.append("Cannot find span size for pre layout position. ");
        recycler.append(i);
        Log.w(str, recycler.toString());
        return 0;
    }
    ...
    private int getSpanIndex(Recycler recycler, State state, int i) {
        ...
        String str = TAG;
        recycler = new StringBuilder();
        recycler.append("Cannot find span size for pre layout position. It is not cached, not in the adapter. Pos:");
        recycler.append(i);
        Log.w(str, recycler.toString());
        return 0;
    }
