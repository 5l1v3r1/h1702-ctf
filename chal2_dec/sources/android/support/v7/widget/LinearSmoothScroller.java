...
public class LinearSmoothScroller extends SmoothScroller {
    ...
    protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
        return 1103626240 / ((float) displayMetrics.densityDpi);
    }
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        String str = TAG;
        i = new StringBuilder();
        i.append("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
        i.append(ScrollVectorProvider.class.getCanonicalName());
