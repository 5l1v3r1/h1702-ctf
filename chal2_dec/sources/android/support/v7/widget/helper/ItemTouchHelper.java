...
public class ItemTouchHelper extends ItemDecoration implements OnChildAttachStateChangeListener {
    ...
    private final OnItemTouchListener mOnItemTouchListener = new OnItemTouchListener() {
        public boolean onInterceptTouchEvent(RecyclerView recyclerView, MotionEvent motionEvent) {
            ...
            recyclerView = MotionEventCompat.getActionMasked(motionEvent);
            ...
            if (ItemTouchHelper.this.mActivePointerId != -1) {
                ...
                if (viewHolder != null) {
                    ...
                    if (recyclerView != 6) {
                        ...
                        recyclerView = MotionEventCompat.getActionIndex(motionEvent);
        ...
        public void onRequestDisallowInterceptTouchEvent(boolean z) {
            if (z) {
                ItemTouchHelper.this.select(false, 0);
            }
        }
    };
    ...
    public static abstract class Callback {
        ...
        public int convertToAbsoluteDirection(int i, int i2) {
            ...
            i2 = i3 >> 1;
            return ((RELATIVE_DIR_FLAGS & i2) >> 2) | (i | (-3158065 & i2));
        }
        ...
        public ViewHolder chooseDropTarget(ViewHolder viewHolder, List<ViewHolder> list, int i, int i2) {
            ...
            for (int i4 = 0; i4 < size; i4++) {
                ...
                if (left > 0) {
                    right = viewHolder3.itemView.getRight() - width;
                ...
                if (top > 0) {
                    right = viewHolder3.itemView.getBottom() - height;
        ...
        public void onMoved(RecyclerView recyclerView, ViewHolder viewHolder, int i, ViewHolder viewHolder2, int i2, int i3, int i4) {
            ...
            if ((layoutManager instanceof ViewDropHandler) != 0) {
                ((ViewDropHandler) layoutManager).prepareForDrop(viewHolder.itemView, viewHolder2.itemView, i3, i4);
                return;
            }
            if (layoutManager.canScrollHorizontally() != null) {
        ...
        public int interpolateOutOfBoundsScroll(RecyclerView recyclerView, int i, int i2, int i3, long j) {
            float f = 1.0f;
            int signum = (int) (((float) (((int) Math.signum((float) i2)) * getMaxDragScroll(recyclerView))) * sDragViewScrollCapInterpolator.getInterpolation(Math.min(1.0f, (((float) Math.abs(i2)) * 1065353216) / ((float) i))));
            if (j <= 2000) {
