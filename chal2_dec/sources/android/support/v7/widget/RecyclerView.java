...
public class RecyclerView extends ViewGroup implements ScrollingView, NestedScrollingChild {
    ...
    public static abstract class Adapter<VH extends ViewHolder> {
        ...
        public final void bindViewHolder(VH vh, int i) {
            ...
            if ((layoutParams instanceof LayoutParams) != null) {
    ...
    public static abstract class LayoutManager {
        ...
        public void moveView(int i, int i2) {
            ...
            if (childAt == null) {
                ...
                i2.append("Cannot move a child from non-existing index:");
                i2.append(i);
        ...
        public void onInitializeAccessibilityEvent(Recycler recycler, State state, AccessibilityEvent accessibilityEvent) {
            ...
            if (this.mRecyclerView != null) {
                if (recycler != null) {
                    accessibilityEvent = true;
                    if (ViewCompat.canScrollVertically(this.mRecyclerView, 1) == null && ViewCompat.canScrollVertically(this.mRecyclerView, -1) == null && ViewCompat.canScrollHorizontally(this.mRecyclerView, -1) == null) {
                        if (ViewCompat.canScrollHorizontally(this.mRecyclerView, 1) == null) {
                            accessibilityEvent = null;
                        }
                    }
                    recycler.setScrollable(accessibilityEvent);
                    if (this.mRecyclerView.mAdapter != null) {
                        recycler.setItemCount(this.mRecyclerView.mAdapter.getItemCount());
                    }
                }
            }
        }
        ...
        public boolean performAccessibilityAction(Recycler recycler, State state, int i, Bundle bundle) {
            ...
            if (i != 4096) {
                if (i != 8192) {
                    ...
                    recycler = ViewCompat.canScrollVertically(this.mRecyclerView, -1) != null ? -((getHeight() - getPaddingTop()) - getPaddingBottom()) : null;
                    if (ViewCompat.canScrollHorizontally(this.mRecyclerView, -1) != 0) {
    ...
    public static class RecycledViewPool {
        ...
        public ViewHolder getRecycledView(int i) {
            ...
            if (scrapData == null || scrapData.mScrapHeap.isEmpty() != 0) {
                return null;
            }
        ...
        public void bindViewToPosition(View view, int i) {
            ...
            if (findPositionOffset >= 0) {
                if (findPositionOffset < RecyclerView.this.mAdapter.getItemCount()) {
                    ...
                    android.view.ViewGroup.LayoutParams layoutParams2 = view.itemView.getLayoutParams();
                    if (layoutParams2 == 0) {
                    ...
                    i = 1;
                    layoutParams.mInsetsDirty = true;
                    layoutParams.mViewHolder = view;
                    if (view.itemView.getParent() != null) {
                        i = 0;
                    }
                    layoutParams.mPendingInvalidate = i;
                    return;
                }
            }
            StringBuilder stringBuilder = new StringBuilder();
        ...
        ViewHolder getScrapOrHiddenOrCachedHolderForPosition(int i, boolean z) {
            ...
            if (!z) {
                ...
                if (findHiddenNonRemovedView != null) {
                    ...
                    if (z) {
                        z = new StringBuilder();
                        z.append("layout index should not be -1 after unhiding a view:");
                        z.append(i);
                        throw new IllegalStateException(z.toString());
                    }
            ...
            for (size = this.mAttachedScrap.size() - 1; size >= 0; size--) {
                ...
                if (viewHolder.getItemId() == j && !viewHolder.wasReturnedFromScrap()) {
                    if (i == viewHolder.getItemViewType()) {
                        viewHolder.addFlags(32);
                        if (!(viewHolder.isRemoved() == null || RecyclerView.this.mState.isPreLayout())) {
    ...
    class ViewFlinger implements Runnable {
        ...
        public void run() {
            ...
            ScrollerCompat scrollerCompat = r0.mScroller;
            ...
            if (scrollerCompat.computeScrollOffset()) {
                ...
                if (!(i == 0 && i2 == 0)) {
                    int i5;
                    itemCount = (int) scrollerCompat.getCurrVelocity();
                    if (i != currX) {
                        if (i < 0) {
                            i5 = -itemCount;
                        } else if (i > 0) {
                        ...
                        if (i2 != currY) {
                            ...
                            if ((i5 != 0 || i == currX || scrollerCompat.getFinalX() == 0) && (itemCount != 0 || i2 == currY || scrollerCompat.getFinalY() == 0)) {
                ...
                boolean z2 = i4 != 0 && RecyclerView.this.mLayout.canScrollVertically() && scrollVerticallyBy == i4;
                boolean z3 = i3 != 0 && RecyclerView.this.mLayout.canScrollHorizontally() && scrollHorizontallyBy == i3;
                if (!((i3 == 0 && i4 == 0) || z3)) {
                    if (!z2) {
                        z = false;
        ...
        private int computeScrollDuration(int i, int i2, int i3, int i4) {
            ...
            if (i3 > 0) {
                round = 4 * Math.round(1148846080 * Math.abs(i4 / ((float) i3)));
            } else {
                if (obj == null) {
                    abs = abs2;
                }
                round = (int) (((((float) abs) / i2) + 1.0f) * 1133903872);
            }
        ...
        if (str != null) {
            ...
            if (str.length() != 0) {
                ...
                try {
                    ...
                    e.initCause(context2);
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Error creating LayoutManager ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e);
                } catch (Throwable e2) {
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Unable to find LayoutManager ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e2);
                } catch (Throwable e22) {
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Could not instantiate the LayoutManager: ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e22);
                } catch (Throwable e222) {
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Could not instantiate the LayoutManager: ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e222);
                } catch (Throwable e2222) {
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Cannot access non-public constructor ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e2222);
                } catch (Throwable e22222) {
                    i = new StringBuilder();
                    i.append(attributeSet.getPositionDescription());
                    i.append(": Class is not a LayoutManager ");
                    i.append(str);
                    throw new IllegalStateException(i.toString(), e22222);
                }
            }
        }
    }
            ...
            public void attachViewToParent(View view, int i, android.view.ViewGroup.LayoutParams layoutParams) {
                ...
                if (childViewHolderInt != null) {
                    if (childViewHolderInt.isTmpDetached() || childViewHolderInt.shouldIgnore()) {
                        ...
                        view.append("Called attach on a child which is not detached: ");
                        view.append(childViewHolderInt);
                ...
                if (childAt != null) {
                    ...
                    if (childViewHolderInt != null) {
                        if (!childViewHolderInt.isTmpDetached() || childViewHolderInt.shouldIgnore()) {
                            ...
                            i = new StringBuilder();
                            i.append("called detach on an already detached child ");
    ...
    private boolean isPreferredNextFocusAbsolute(View view, View view2, int i) {
        ...
        if (i == 17) {
            ...
            view = new StringBuilder();
            view.append("direction must be absolute. received:");
            view.append(i);
            throw new IllegalArgumentException(view.toString());
        } else {
                ...
                case 2:
                    ...
                    if (actionMasked >= 0) {
                        ...
                        if (this.mScrollState != 1) {
                            ...
                            motionEvent -= this.mInitialTouchY;
                            actionMasked = -1;
                            ...
                            if (canScrollVertically && Math.abs(motionEvent) > this.mTouchSlop) {
                    ...
                    if (findViewHolderForItemId.itemView.hasFocusable()) {
                        ...
                        if (view != null) {
                            if (((long) this.mState.mFocusedSubChildId) != -1) {
                                findViewById = view.findViewById(this.mState.mFocusedSubChildId);
    ...
    private void handleMissingPreInfoForChangeError(long j, ViewHolder viewHolder, ViewHolder viewHolder2) {
            ...
            if (childViewHolderInt != viewHolder) {
                if (getChangedHolderKey(childViewHolderInt) == j) {
                    if (this.mAdapter == null || !this.mAdapter.hasStableIds()) {
                        j = new StringBuilder();
                        j.append("Two different ViewHolders have the same change ID. This might happen due to inconsistent Adapter update events or if the LayoutManager lays out the same View multiple times.\n ViewHolder 1:");
                        j.append(childViewHolderInt);
                        j.append(" \n View Holder 2:");
                        j.append(viewHolder);
                        throw new IllegalStateException(j.toString());
                    }
                    j = new StringBuilder();
                    j.append("Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:");
                    j.append(childViewHolderInt);
                    j.append(" \n View Holder 2:");
                    j.append(viewHolder);
                    throw new IllegalStateException(j.toString());
        ...
        String str = TAG;
        j = new StringBuilder();
        j.append("Problem while matching changed view holders with the newones. The pre-layout information for the change holder ");
    ...
    protected void removeDetachedView(View view, boolean z) {
        ...
        if (childViewHolderInt != null) {
            if (childViewHolderInt.isTmpDetached()) {
                ...
                view = new StringBuilder();
                view.append("Called removeDetachedView with a view which is not flagged as tmp detached.");
                view.append(childViewHolderInt);
                throw new IllegalArgumentException(view.toString());
            }
        }
