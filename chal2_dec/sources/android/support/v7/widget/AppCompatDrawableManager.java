...
public final class AppCompatDrawableManager {
    ...
    private Drawable tintDrawable(@NonNull Context context, @DrawableRes int i, boolean z, @NonNull Drawable drawable) {
        ...
        if (tintList != null) {
            ...
            r3 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908288), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        } else {
            ...
            r3 = (LayerDrawable) drawable;
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908288), ThemeUtils.getDisabledThemeAttrColor(context, R.attr.colorControlNormal), DEFAULT_MODE);
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908303), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), DEFAULT_MODE);
            setPorterDuffColorFilter(r3.findDrawableByLayerId(16908301), ThemeUtils.getThemeAttrColor(context, R.attr.colorControlActivated), DEFAULT_MODE);
            return drawable;
        }
    }
    ...
    private android.graphics.drawable.Drawable getCachedDrawable(@android.support.annotation.NonNull android.content.Context r4, long r5) {
        /*
        r3 = this;
        r0 = r3.mDrawableCacheLock;
        monitor-enter(r0);
        r3 = r3.mDrawableCaches;	 Catch:{ all -> 0x002f }
        r3 = r3.get(r4);	 Catch:{ all -> 0x002f }
        r3 = (android.support.v4.util.LongSparseArray) r3;	 Catch:{ all -> 0x002f }
        r1 = 0;
    ...
    L_0x000e:
        ...
        return r1;
    L_0x0010:
        r2 = r3.get(r5);	 Catch:{ all -> 0x002f }
        r2 = (java.lang.ref.WeakReference) r2;	 Catch:{ all -> 0x002f }
        if (r2 == 0) goto L_0x002d;
    L_0x0018:
        r2 = r2.get();	 Catch:{ all -> 0x002f }
        r2 = (android.graphics.drawable.Drawable.ConstantState) r2;	 Catch:{ all -> 0x002f }
        if (r2 == 0) goto L_0x002a;
    L_0x0020:
        r3 = r4.getResources();	 Catch:{ all -> 0x002f }
        r3 = r2.newDrawable(r3);	 Catch:{ all -> 0x002f }
        monitor-exit(r0);	 Catch:{ all -> 0x002f }
        return r3;
    L_0x002a:
