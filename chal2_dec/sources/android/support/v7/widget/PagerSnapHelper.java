...
public class PagerSnapHelper extends SnapHelper {
    ...
    public int findTargetSnapPosition(android.support.v7.widget.RecyclerView.LayoutManager r5, int r6, int r7) {
        /*
        r4 = this;
        r0 = r5.getItemCount();
        r1 = -1;
    ...
    L_0x0008:
        r2 = 0;
        r3 = r5.canScrollVertically();
        if (r3 == 0) goto L_0x0018;
    L_0x000f:
        r2 = r4.getVerticalHelper(r5);
        r2 = r4.findStartView(r5, r2);
        goto L_0x0026;
    L_0x0018:
        r3 = r5.canScrollHorizontally();
        if (r3 == 0) goto L_0x0026;
    L_0x001e:
        r2 = r4.getHorizontalHelper(r5);
        r2 = r4.findStartView(r5, r2);
    L_0x0026:
    ...
    L_0x0028:
        return r1;
    L_0x0029:
        r4 = r5.getPosition(r2);
        if (r4 != r1) goto L_0x0030;
    L_0x002f:
        return r1;
    L_0x0030:
        r1 = r5.canScrollHorizontally();
        r2 = 0;
        r3 = 1;
    ...
    L_0x0040:
        goto L_0x003a;
    L_0x0041:
        r7 = r5 instanceof android.support.v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider;
        if (r7 == 0) goto L_0x005c;
    L_0x0045:
        r5 = (android.support.v7.widget.RecyclerView.SmoothScroller.ScrollVectorProvider) r5;
        r0 = r0 - r3;
        r5 = r5.computeScrollVectorForPosition(r0);
    ...
    protected LinearSmoothScroller createSnapScroller(LayoutManager layoutManager) {
        ...
        return new LinearSmoothScroller(this.mRecyclerView.getContext()) {
            ...
            protected float calculateSpeedPerPixel(DisplayMetrics displayMetrics) {
                return 1120403456 / ((float) displayMetrics.densityDpi);
            }
