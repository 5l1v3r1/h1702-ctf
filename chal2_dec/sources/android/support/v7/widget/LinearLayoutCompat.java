...
public class LinearLayoutCompat extends ViewGroup {
    ...
    void measureVertical(int i, int i2) {
                    ...
                    if (virtualChildCount >= i10 || layoutParams.weight <= 0.0f) {
                        ...
                        if (mode != 1073741824) {
                            ...
                            if (layoutParams.width == -1) {
                                ...
                                i13 = ViewUtils.combineMeasuredStates(i21, ViewCompat.getMeasuredState(view));
        ...
        i7 = i2;
        i11 = ViewCompat.resolveSizeAndState(Math.max(r7.mTotalLength, getSuggestedMinimumHeight()), i7, 0);
        ...
        if (i14 == 0) {
            if (i9 == 0 || f <= 0.0f) {
                ...
                setMeasuredDimension(ViewCompat.resolveSizeAndState(Math.max(mode2 + (getPaddingLeft() + getPaddingRight()), getSuggestedMinimumWidth()), i8, i3), i11);
                if (i15 != 0) {
                ...
                if (f5 > 0.0f) {
                    ...
                    if (layoutParams4.height == 0) {
                        ...
                        if (i13 == 1073741824) {
                            ...
                            i9 = ViewUtils.combineMeasuredStates(i9, ViewCompat.getMeasuredState(virtualChildAt4) & InputDeviceCompat.SOURCE_ANY);
                        }
                    } else {
                        i25 = 1073741824;
                    }
    ...
    void measureHorizontal(int i, int i2) {
            ...
            if (virtualChildAt2 == null) {
                ...
                if (mode == i10 && layoutParams3.width == 0 && layoutParams3.weight > 0.0f) {
                    ...
                    if (z3) {
                        ...
                        combineMeasuredStates = ViewUtils.combineMeasuredStates(i17, ViewCompat.getMeasuredState(view));
                        if (z2) {
        ...
        i3 = ViewCompat.resolveSizeAndState(Math.max(r7.mTotalLength, getSuggestedMinimumWidth()), i, 0);
        ...
        if (i14 == 0) {
            if (combineMeasuredStates == 0 || f <= 0.0f) {
                ...
                setMeasuredDimension(i3 | (ViewCompat.MEASURED_STATE_MASK & i6), ViewCompat.resolveSizeAndState(Math.max(mode + (getPaddingTop() + getPaddingBottom()), getSuggestedMinimumHeight()), i9, i6 << 16));
                if (i18 == 0) {
                    ...
                    if (f3 > 0.0f) {
                        ...
                        if (layoutParams.width == 0) {
                            ...
                            if (i12 == 1073741824) {
                                ...
                                i6 = ViewUtils.combineMeasuredStates(i6, ViewCompat.getMeasuredState(virtualChildAt3) & ViewCompat.MEASURED_STATE_MASK);
                            }
                        } else {
                            combineMeasuredStates = 1073741824;
                        }
