...
public class SodiumJNI {
    ...
    public static final native int crypto_pwhash_scryptsalsa208sha256(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, int i4);

    public static final native int crypto_pwhash_scryptsalsa208sha256_ll(byte[] bArr, int i, byte[] bArr2, int i2, int i3, int i4, int i5, byte[] bArr3, int i6);
    ...
    public static final native int crypto_pwhash_scryptsalsa208sha256_str(byte[] bArr, byte[] bArr2, int i, int i2, int i3);

    public static final native int crypto_pwhash_scryptsalsa208sha256_str_verify(byte[] bArr, byte[] bArr2, int i);
