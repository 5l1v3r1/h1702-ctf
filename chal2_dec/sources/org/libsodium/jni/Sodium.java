...
public class Sodium {
    ...
    public static int crypto_pwhash_scryptsalsa208sha256(byte[] bArr, int i, byte[] bArr2, int i2, byte[] bArr3, int i3, int i4) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256(bArr, i, bArr2, i2, bArr3, i3, i4);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_str(byte[] bArr, byte[] bArr2, int i, int i2, int i3) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_str(bArr, bArr2, i, i2, i3);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_str_verify(byte[] bArr, byte[] bArr2, int i) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_str_verify(bArr, bArr2, i);
    }

    public static int crypto_pwhash_scryptsalsa208sha256_ll(byte[] bArr, int i, byte[] bArr2, int i2, int i3, int i4, int i5, byte[] bArr3, int i6) {
        return SodiumJNI.crypto_pwhash_scryptsalsa208sha256_ll(bArr, i, bArr2, i2, i3, i4, i5, bArr3, i6);
    }
