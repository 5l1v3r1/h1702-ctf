...
.method public constructor <init>()V
    ...
    iget-object p0, p0, Lorg/libsodium/jni/keys/KeyPair;->secretKey:[B

    invoke-static {v0, p0}, Lorg/libsodium/jni/Sodium;->crypto_box_curve25519xsalsa20poly1305_keypair([B[B)I
...
.method public constructor <init>([B)V
    ...
    invoke-static {v0, p0, p1}, Lorg/libsodium/jni/Sodium;->crypto_box_curve25519xsalsa20poly1305_seed_keypair([B[B[B)I

    move-result p0

    const-string p1, "Failed to generate a key pair"
...
.method public getPrivateKey()Lorg/libsodium/jni/keys/PrivateKey;
    ...
    invoke-direct {v0, p0}, Lorg/libsodium/jni/keys/PrivateKey;-><init>([B)V
...
.method public getPublicKey()Lorg/libsodium/jni/keys/PublicKey;
    ...
    iget-object p0, p0, Lorg/libsodium/jni/keys/KeyPair;->publicKey:[B
    ...
    invoke-virtual {v0, p0}, Lorg/libsodium/jni/crypto/Point;->mult([B)Lorg/libsodium/jni/crypto/Point;

    move-result-object p0

    invoke-virtual {p0}, Lorg/libsodium/jni/crypto/Point;->toBytes()[B
    ...
    invoke-direct {v0, p0}, Lorg/libsodium/jni/keys/PublicKey;-><init>([B)V
