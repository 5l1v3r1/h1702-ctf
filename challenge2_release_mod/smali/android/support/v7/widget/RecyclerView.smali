...
.method private getScrollFactor()F
    ...
    :cond_1
    :goto_0
    iget p0, p0, Landroid/support/v7/widget/RecyclerView;->mScrollFactor:F
...
.method private handleMissingPreInfoForChangeError(JLandroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    const-string p2, "Two different ViewHolders have the same stable ID. Stable IDs in your adapter MUST BE unique and SHOULD NOT change.\n ViewHolder 1:"
    ...
    const-string p2, "Two different ViewHolders have the same change ID. This might happen due to inconsistent Adapter update events or if the LayoutManager lays out the same View multiple times.\n ViewHolder 1:"
...
.method assertNotInLayoutOrScroll(Ljava/lang/String;)V
    ...
    .line 2580
    :cond_1
    iget p0, p0, Landroid/support/v7/widget/RecyclerView;->mDispatchScrollCounter:I

    if-lez p0, :cond_2

    const-string p0, "RecyclerView"

    const-string p1, "Cannot call this method in a scroll callback. Scroll callbacks mightbe run during a measure & layout pass where you cannot change theRecyclerView data. Any method call that might change the structureof the RecyclerView or the adapter contents should be postponed tothe next frame."
...
.method ensureBottomGlow()V
    ...
    invoke-virtual {v0, v1, p0}, Landroid/support/v4/widget/EdgeEffectCompat;->setSize(II)V
